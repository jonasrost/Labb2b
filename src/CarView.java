...
public class CarView extends JFrame implements RefreshObserver {
    ...
    private VehicleAddOrRemovePanel addOrRemovePanel;
    ...
    public CarView(String framename, CarController cc, CarModel cm){
        ...
        addOrRemovePanel = new VehicleAddOrRemovePanel(cc);
    ...
    private void initComponents(String title) {
        ...
        startButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) { carC.startVehicles(); }
        });

        stopButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) { carC.stopVehicles(); }
        });
